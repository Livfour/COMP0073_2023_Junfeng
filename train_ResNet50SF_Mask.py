...
if __name__ == "__main__":
    writer = SummaryWriter("./runs/Single_Frame_ViT_Mask_01")
    device = torch.device("cuda" if torch.cuda.is_available() else "cpu")
    device_name = torch.cuda.get_device_name(0)
    model_path = "./checkpoints/Single_Frame_ViT_Mask_01.pth"
    best_model_path = "./checkpoints/Single_Frame_ViT_Mask_Best_01.pth"
