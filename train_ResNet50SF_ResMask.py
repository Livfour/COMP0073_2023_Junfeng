...
from utilities.loss import JointsMSELoss
...
if __name__ == "__main__":
    writer = SummaryWriter("./runs/Single_Frame_ViT_ResMask_01")
    device = torch.device("cuda" if torch.cuda.is_available() else "cpu")
    device_name = torch.cuda.get_device_name(0)
    model_path = "./checkpoints/Single_Frame_ViT_ResMask_01.pth"
    best_model_path = "./checkpoints/Single_Frame_ViT_ResMask_Best_01.pth"
    pretrained_path = "./checkpoints/vitpose_base_coco_aic_mpii.pth"
    # Please change this to the path of PoseTrack21 dataset
